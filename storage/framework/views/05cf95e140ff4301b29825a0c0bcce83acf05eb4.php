            ...
            if (checkbox.checked) {
              ...
              <div class="row mb-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?php echo e(route('adminpanel.Invoices.store')); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>                                
                                <div class="row mb-3">
                                  <div class="col-md-5">
                                    <label for="category_id">Add Customer</label>
                                    <select name="customer_name" id="category_id" class="form-control <?php $__errorArgs = ['category_id'];
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="<?php echo e($customer->name); ?>" style="color: rgb(6, 5, 5); font-size: 18px;" ><?php echo e($customer->name); ?></option>       
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="estimate_date" id="price" class="form-control <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" name="estimate_no" id="price" class="form-control <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is_invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($estno); ?>" readonly>
                                                <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="date" name="expiray_date" id="price" class="form-control <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is_invalid <?php unset($message);
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="recurrence_frequency" id="recurrence_frequency" style="display: none;" class="form-control <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                                ...
                                                <div class="col">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <select name="recurrence_status" id="recurrence_status" style="display: none;" class="form-control <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('attach.jpg')); ?>" class="img-fluid" alt="template_1" onclick="selectImage(this, 'template-1')">
                    </div>
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('attach.jpg')); ?>" class="img-fluid" alt="template_2" onclick="selectImage(this, 'template-2')">
                    </div>
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('attach.jpg')); ?>" class="img-fluid" alt="template_3" onclick="selectImage(this, 'template-3')">
                    </div>
                </div>
                <div class="row mt-3">
        ...
        document.getElementById('totalamount').value = amount * quantity2 ;
                                  ...
                                  <div class="row mb-3">
                                    <div class="col-md-5">
                                      ...
                                      <select name="item" id="category_id" name="item"  class="form-control <?php $__errorArgs = ['category_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                          ...
                                          <option value="<?php echo e($item->name); ?>"style="color: rgb(6, 5, 5); font-size: 18px;" ><?php echo e($item->name); ?></option>       
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> 
                                 ...
                                 <div class="row mb-3">
                                  ...
                                  <div class="col-md-6" >
                                      <div class="form-group mb-3">
                                          ...
                                          <textarea name="notes" id="notes" cols="25" rows="10" class="form-control <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is_invalid <?php unset($message);
...
<?php echo $__env->make('layouts.user_type.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Invoice_system\resources\views/laravel-examples/Invoices/create.blade.php ENDPATH**/ ?>