...
<body >
    <div class="container-fluid">
          ...
          <div class="table-responsive p-0">
            <table class="table align-items-center mb-0 mt-4" >
                ...
                <tbody>
                    ...
                    <td >
                        <p class="text-xs font-weight-bold mb-0"><?php echo e($item->cust_name); ?></p>
                    </td>
        ...
        <div class="row mx-0 px-0 mt-4">
            ...
            <a id="downloadButton" href="<?php echo e(route('adminpanel.Invoices.download', $item->id)); ?>" class="btn bg-gradient-primary btn-sm mb-0" type="button"></a>
...
<?php /**PATH C:\xampp\htdocs\Invoice_system\resources\views/laravel-examples/Invoices/template_1.blade.php ENDPATH**/ ?>