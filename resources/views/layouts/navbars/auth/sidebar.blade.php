  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{route('adminpanel.Customers')}}">
            {{-- <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('Items') ? 'active' : '') }}" href="{{route('adminpanel.items')}}">
            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
            <lord-icon
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('adminpanel.Estimates') ? 'active' : '') }}" href="{{route('adminpanel.Estimates')}}">
            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
            <lord-icon
                src="https://cdn.lordicon.com/aqajnirr.json"
                trigger="hover"
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('adminpanel.Invoices') ? 'active' : '') }}" href="{{route('adminpanel.Invoices')}}">
            <script src="https://cdn.lordicon.com/bhenfmcm.js"></script>
            <lord-icon
                src="https://cdn.lordicon.com/aqajnirr.json"
                trigger="hover"
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('user-management') ? 'active' : '') }}" href="{{route('adminpanel')}}">
            {{-- <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div> --}}
            <lord-icon
