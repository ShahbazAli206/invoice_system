        ...
        <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" id="notificationDropdownn" style="min-width: 290px;">
                        ...
                        <li class="d-flex justify-content-end mx-1 my-2">
                            <a href="{{route('mark-as-read')}}" style="color: #ffffff; font-size: 14px;width: 80px; border-radius: 5px; background-color: #4CAF50; padding: 5px 5px; border: none; cursor: pointer;"
                        ...
                        <form action="{{ route('mark-read', $notification->id) }}" method="POST">
                            ...
                            <button type="submit" style="color: #cf2222; font-size: 16px; width: 280px; border-radius: 5px; background-color: #4CAF50; padding: 5px; margin-bottom: 20px; cursor: pointer;">{{ $notification->data['data'] }}</button>
                        </form>
                        ...
                        <li style="color: #171515; font-size: 16px;width: 280px; border-radius: 5px; background-color: #8bdfee; padding: 5px 5px; margin-bottom: 20px;"> {{$notification->data['data']}}</li>
                        @endforeach
            </ul>
        </li>
        <li>
