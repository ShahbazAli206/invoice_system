            ...
            <div class="card-body" >
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="@error('user.name')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ auth()->user()->name }}" style=" color: rgb(1, 0, 0); font-size: 16px;" type="text" placeholder="Name" id="user-name" name="name">
                                    @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="@error('email')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ auth()->user()->email }}" style=" color: rgb(1, 0, 0); font-size: 16px;" type="email" placeholder="@example.com" id="user-email" name="email">
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="@error('email')border border-danger rounded-3 @enderror">
                                <input class="form-control" style=" color: rgb(1, 0, 0); font-size: 16px;" value="{{ auth()->user()->ph_no }}" type="text" placeholder="03000000000" id="user-ph_no" name="ph_no">
                                    @error('email')
                                        <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                    @enderror
                            </div>
